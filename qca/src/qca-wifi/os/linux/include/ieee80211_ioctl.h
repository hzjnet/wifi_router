...
enum {
    ...
    IEEE80211_DBGREQ_SON_MAP_ASSOC_FRAME          = 79, /* SON related for MAP implementaion */
    IEEE80211_DBGREQ_SON_MAP_CAP                  = 80, /* SON related for MAP Capability */
    IEEE80211_DBGREQ_SON_MAP_APCAP                = 81,
};
...
typedef struct {
    ...
    u_int8_t txpow;
    u_int8_t num_unopch;
    u_int8_t unopch[MAX_CHANNELS_PER_OPERATING_CLASS];
    u_int8_t num_opch;
    u_int8_t opch[MAX_CHANNELS_PER_OPERATING_CLASS];
} map_unoperable_ch;

typedef struct {
    u_int8_t radiomac[IEEE80211_ADDR_LEN];
    u_int8_t maxbss;
    u_int8_t opclasscnt;
    u_int8_t  htcap;
    u_int16_t vhttxmcs;
    u_int16_t vhtrxmcs;
    u_int8_t  vhtspstreams;
    u_int8_t  vhtcap;
    u_int8_t  band;//1 for 2.4 G , 2 for 5GL, 3 for 5G H.
    u_int32_t length;
    void *data;
} ieee80211req_map_apcap_data;

typedef struct {
    u_int32_t length;
    // need to fill up client capability report;
    //  0 success, 1 unspecified error, 2 not connected client
    u_int32_t status;
    void *data;
} ieee80211req_map_data_t;
...
#endif
        ieee80211req_map_data_t mapdata;
        ieee80211req_map_apcap_data mapapcap;
    } data;
} __packed;
