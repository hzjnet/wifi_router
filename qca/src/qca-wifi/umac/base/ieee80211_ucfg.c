   ...
   break;
    ...
    case IEEE80211_PARAM_MAP_BSS_TYPE:
        if (val) {
            ...
            if (ieee80211_vap_mapfh_is_clear(vap))
                retv = -EALREADY;
            else {
            ...
            if (ieee80211_vap_mapbh_is_clear(vap))
                retv = -EALREADY;
            else {
            ...
            if (ieee80211_vap_mapbsta_is_clear(vap))
                retv = -EALREADY;
            else {
